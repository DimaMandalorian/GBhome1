...
if (detal % sum_proizvodstvo == 0)
{
    ...
    WriteLine($"Каждый токарь младшего разряда сделал {detal / sum_proizvodstvo*tokar_1}");
    WriteLine($"Каждый токарь старшего разряда сделал {detal / sum_proizvodstvo*tokar_4}");
}
else    WriteLine("токарь ошибся");
